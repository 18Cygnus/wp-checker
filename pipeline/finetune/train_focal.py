...
def evaluate(model, dataloader, device, num_labels, loss_fn=None):
...
def main():
    ...
    parser.add_argument(
        ...
        help="Training loss: ce, weighted_ce, or focal",
    )
    ...
    if args.loss_type == "ce":
        ...
        loss_fn = FocalLoss(alpha=weight_tensor, gamma=args.focal_gamma)
    ...
    print(f"  loss_type={args.loss_type}, focal_gamma={args.focal_gamma}")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        val_loss, val_acc, val_macro_f1, val_per_label_f1, _, _ = evaluate(
            model, val_loader, device, num_labels, loss_fn=loss_fn
        )
    ...
    hparams = {
        ...
        "class_weights_used": weights_path.exists() and args.loss_type in {"weighted_ce", "focal"},
    }
